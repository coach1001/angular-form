...
@Component({
  selector: 'app-normal-number-field',
  templateUrl: './normal-number-field.component.html',
  styleUrls: ['./normal-number-field.component.scss']
})
export class NormalNumberFieldComponent extends DuiBaseControlComponent {
